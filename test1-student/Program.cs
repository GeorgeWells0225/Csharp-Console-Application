...
namespace hanxu
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("排序后的学生信息:"); paixu(t, stu); Console.Read();
        }
    ...
    class score
    {
        private string name; private int ID; private double c; private double english; private double math; double avg; public score() { this.avg = 0; }
        public string Name
